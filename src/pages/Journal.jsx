      ...
      {filteredEntries.length > 0 ? (
        ...
        <div className="card p-8 mt-6 text-center rounded-xl shadow-sm">
          {entries.length > 0 ? (
            ...
            <>
              <h3 className="text-lg font-playwrite font-medium text-neutral-800 dark:text-white mb-4">
                Your journal is empty!
              </h3>
              <p className="font-libre-baskerville text-sm text-neutral-600 dark:text-neutral-400 mb-8">
