                ...
                {entry.micro_goals.map((goal, index) => (
                  <div key={index} className="flex items-center gap-3">
                    <button
                      ...
                      className={`w-5 h-5 rounded border-2 flex items-center justify-center transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-primary-400 dark:focus:ring-primary-400 ${goal.is_completed
