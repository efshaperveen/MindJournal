          ...
          >
            ...
            {isToday && (
              <button
                ...
                className="mt-6 px-28 py-2 space-x-2 font-libre-baskerville text-[15px] bg-primary-500 text-white rounded-xl hover:bg-primary-600 transition flex items-center"
              >
